...
export const videos = [
  { id: "jZ7npJ8L0q8", label: "Conversion Transformation 01" },
  { id: "8lZtRGMK9dA", label: "Conversion Transformation 02" },
  { id: "rROrt_czWuA", label: "Conversion Transformation 03" }
] as const;

export const team = [
  { name: "Michael Olajire", role: "Lead Developer", image: "https://www.image2url.com/r2/default/files/1781972553333-9f947246-241c-48c5-8ab4-6d6ad002291c.png", fiverr: "https://www.fiverr.com/michae1_olajire" },
  { name: "Timi Oladunjoye", role: "Project Manager", image: "https://www.image2url.com/r2/default/files/1781975254786-3bb68a88-aa4e-b14c3526b28a.jpg", email: "mailto:oladunjoyemalik5@gmail.com" },
  { name: "DeTruth", role: "Project Manager and Marketing Specialist", initials: "DT", fiverr: "https://www.fiverr.com/dreal_detruth" },
  { name: "Michy", role: "Backend Developer and Technical Optimization Specialist", image: "https://www.image2url.com/r2/default/images/1782248757353-fd08206d-9021-41cc-9459-79f49b2f128e.png", fiverr: "https://www.fiverr.com/michyblake" },
  { name: "Bams", role: "Marketer", image: "https://www.image2url.com/r2/default/images/1782248251594-f4cc29fd-3492-40de-8f8f-49a86395d3fe.png", fiverr: "https://www.fiverr.com/d_bams" }
] as const;
