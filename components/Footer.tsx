    ...
    <footer className="site-footer">
      <div className="container-main">
        ...
        <div className="footer-main">
          ...
          <div className="footer-social"><a href="https://www.linkedin.com/in/michael-olajire-65a5842b6" target="_blank" rel="noreferrer">LinkedIn</a><a href="https://x.com/Sage_Glyph" target="_blank" rel="noreferrer">X</a><a href="https://wa.link/cubji5" target="_blank" rel="noreferrer">WhatsApp</a></div>
        </div>
