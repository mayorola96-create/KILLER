...
import { siFacebook, siInstagram, siWhatsapp, siX } from "simple-icons/icons";
...
const contacts = [
  ...
  { label: "X", value: "Follow Sage Partners", href: "https://x.com/_SagePartners", icon: siX },
  { label: "Facebook", value: "Follow Sage Partners", href: "https://www.facebook.com/profile.php?id=61592408152309", icon: siFacebook },
  { label: "Instagram", value: "Follow Sage Partners", href: "https://www.instagram.com/sagepartners.space", icon: siInstagram }
] as const;
      ...
      <div className="container-main">
        ...
        <div className="contact-layout mt-12 lg:mt-16">
          <Reveal className="contact-methods">
            ...
            <a href="mailto:michael.sagepartners@gmail.com" className="contact-card">
              <span className="contact-icon"><Mail size={21} aria-hidden="true" /></span>
              <span><b>Email</b><small>michael.sagepartners@gmail.com</small></span>
              <ArrowUpRight size={19} aria-hidden="true" />
            </a>
...
function ContactForm() {
  ...
  const onSubmit = async (values: ContactInput) => {
    ...
    try {
      ...
      setStatus({ type: "error", message: "We could not reach the secure form endpoint. Please use email instead.", fallback: "mailto:michael.sagepartners@gmail.com" });
    }
  };
